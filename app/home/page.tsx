  ...
  return (
    <>
      ...
      <div className="relative w-full" style={{zIndex: 2}}>
        ...
        {/* Hero Section dengan background DarkVeil */}
        <section style={{position: "relative", width: "100%", height: "100vh", overflow: "hidden"}}>
          {/* <div style={{position: "absolute", top: 0, left: 0, width: "100%", height: "100%", zIndex: 0}}>
           ...
           <div className="absolute inset-0" style={{background: `
            radial-gradient(ellipse at center, rgba(132, 94, 247, 0.4) 0%, rgba(16, 4, 37, 1) 70%),
            linear-gradient(to bottom, #100425 0%, #ffffff 100%)`}}>
            </div>
        ...
        {/* Project Section dengan background DarkVeil */}
        <section style={{position: "relative", width: "100%", height: "100vh", overflow: "hidden"}}>
          <div style={{position: "absolute", top: 0, left: 0, width: "100%", height: "100%", zIndex: 0}}>
            <DarkVeil />
          </div>
          <div style={{position: "relative", zIndex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: "100%"}}>
            ...
            <h2 className="text-white text-3xl font-bold mb-4">Project Section</h2>
