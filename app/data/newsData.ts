...
export const newsData: NewsItem[] = [
  ...
  },
  {
    ...
    content: [
      "Amidst rapid technological developments, Decodes is taking a major step by collaborating with several local startups. This collaboration is not just a business partnership, but a concrete effort to accelerate digital transformation in Indonesia.",
      "Through this initiative, Decodes aims to deliver innovations that address the challenges of modern industry. Working with startups, Decodes develops relevant digital solutions, from data-driven systems to services that support business efficiency.",
    ],
    program: [
      "Development of digital solutions that support business efficiency",
      "Resource support and network access for startups",
    ...
    objectives: [
      "This collaboration is expected to strengthen the competitiveness of Indonesian startups at the national and global levels."
    ],
    quotes: [
      {
        from: "From Decodes",
        text: "We believe the best innovations come from collaboration. By synergizing with local startups, we are optimistic that we can accelerate digital transformation."
      }
    ]
  },
  {
