...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-[60] mx-auto hidden w-full max-w-7xl flex-row items-center justify-between self-start rounded-full px-4 py-2 lg:flex text-white",
        className,
      )}
    >
      {children}
...
export const NavbarButton = ({
  ...
  const baseStyles =
    ...
    "px-4 py-2 rounded-md bg-black button bg-gradient-to-r from-[#0421DE] to-[#BA8EF4]text-white text-sm font-bold relative cursor-pointer hover:-translate-y-0.5 transition duration-200 inline-block text-center";
