...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "blur(10px) opacity-98 relative z-[100] mx-auto hidden w-full max-w-7xl flex-row items-center justify-between self-start rounded-full px-4 py-3 lg:flex text-[#F7DDEE]",
        className
      )}
    >
      {children}
...
export const NavbarButton = ({
  ...
  children: React.ReactNode;
  className?: string;
  variant?: "primary" | "secondary" | "dark" | "gradient" | "gradientOutline";
} & (
